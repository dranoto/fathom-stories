...
| `SUMMARY_DEBOUNCE_MINUTES` | `20` | Bounded first-item coalescing window for isolated/manual updates; live grouping and regroup explicitly flush before returning |
